...
void configure_text_card(TextContext& card, const ExecutionCore& execution,
    ...
    // Fork: prefill alone receives the pinned-host checkpoint destination.
    card.set_linear_state_slot(current_state_slot);
    card.set_rewrite_checkpoint_linear_state_output(rewrite_checkpoint_linear_state,
                                                    rewrite_checkpoint_linear_state_bytes);
